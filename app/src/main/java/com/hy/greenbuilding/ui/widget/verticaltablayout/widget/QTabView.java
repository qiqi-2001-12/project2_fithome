package com.hy.greenbuilding.ui.widget.verticaltablayout.widget;
...
public class QTabView extends TabView {
    ...
    private void initView() {
        ...
        if (mTitle == null) {
            ...
            int verticalPadding = DisplayUtil.dp2px(mContext, 30); // 8dp 的内边距
            mTitle.setPadding(0, verticalPadding, 0, verticalPadding);
